...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2af451fb7cf8, const void *arg_0x2af451fb6020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2af452038618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2af4522798e8), 
int (*key_eq_fn)(void *arg_0x2af4522780c8, void *arg_0x2af452278368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2af452489610, int arg_0x2af452489878);
static double RandomUniform(void );
...
uint8_t len);
# 136 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static uint32_t RadioCountToLedsC$MilliTimer$getNow(void );
#line 64
...
uint32_t RadioCountToLedsC$sendTime[1000];
uint32_t RadioCountToLedsC$recieveTime[1000];
uint32_t RadioCountToLedsC$delayTime[1000];
...
# 136 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static uint32_t RadioCountToLedsC$MilliTimer$getNow(void ){
#line 136
  unsigned int __nesc_result;
#line 136
...
#line 136
# 116 "RadioCountToLedsC.nc"
static inline message_t *RadioCountToLedsC$Receive$receive(message_t *bufPtr, 
void *payload, uint8_t len)
#line 117
{
  sim_log_debug(150U, "RadioCountToLedsC", "Received packet of length %hhu.\n", len);
  RadioCountToLedsC$recieveTime[sim_node()] = RadioCountToLedsC$MilliTimer$getNow();
  RadioCountToLedsC$delayTime[sim_node()] = RadioCountToLedsC$recieveTime[sim_node()] - RadioCountToLedsC$sendTime[sim_node()];
  sim_log_debug(151U, "RadioCountToLedsC", "Delay Time: %ld \n", RadioCountToLedsC$delayTime[sim_node()]);
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2af452879340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2af452879340) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2af452879340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2af452878020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2af452878020, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2af45287b220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2af45287b220, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2af452b0c318, message_t * msg, error_t error){
#line 100
  switch (arg_0x2af452b0c318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2af452b0c318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2af45258a020){
#line 75
  switch (arg_0x2af45258a020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2af45258a020);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2af452b0b488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2af452b0b488, addr, msg, len);
#line 80
...
#line 103
      ...
      if (RadioCountToLedsC$AMSend$send(AM_BROADCAST_ADDR, &RadioCountToLedsC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
          ...
          RadioCountToLedsC$sendTime[sim_node()] = RadioCountToLedsC$MilliTimer$getNow();
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2af452d94c28){
#line 83
  switch (arg_0x2af452d94c28) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2af452d94c28);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioCountToLedsC$sendTime"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$sendTime[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$sendTime[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$recieveTime"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$recieveTime[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$recieveTime[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$delayTime"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$delayTime[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$delayTime[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&RadioCountToLedsC$sendTime[__nesc_mote], 0, sizeof RadioCountToLedsC$sendTime[__nesc_mote]);
  memset((void *)&RadioCountToLedsC$recieveTime[__nesc_mote], 0, sizeof RadioCountToLedsC$recieveTime[__nesc_mote]);
  memset((void *)&RadioCountToLedsC$delayTime[__nesc_mote], 0, sizeof RadioCountToLedsC$delayTime[__nesc_mote]);
